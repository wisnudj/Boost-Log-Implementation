...
void init_logging() {
    ...
    (
        keywords::file_name = "9.log_rotation_size_%m-%d-%Y_%H:%M:%S.log",                              /* filename */
    ...
    // add console.log setting for display log to terminal
    logging::add_console_log(std::cout, boost::log::keywords::format = "[%TimeStamp%] [%ThreadID%] [%Severity%] [%ProcessID%] %Message%");
}
